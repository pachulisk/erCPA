-module(antigravity_executor).
-behaviour(gen_server).

%% Antigravity provider executor
%% Uses Google One AI credits as fallback
...
init([Config]) ->
    {ok, #state{config = Config, pool = antigravity_pool}}.
...
build_url(Auth) ->
    ...
    <<BaseURL/binary, "/v1beta/models/gemini-pro:generateContent">>.
