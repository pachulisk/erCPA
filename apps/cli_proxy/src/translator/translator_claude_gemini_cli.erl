-module(translator_claude_gemini_cli).
-behaviour(translator).

%% Claude -> Gemini CLI
%% Gemini CLI uses Gemini generateContent format; delegates to translator_claude_gemini.
...
register() ->
    translator_registry:register(claude, gemini_cli, ?MODULE).
